...
Updated agents send capability hashes and changed state between six-hour reconciliations. Existing agents remain compatible, and the application automatically compacts legacy telemetry during startup after verifying the replacement database.
