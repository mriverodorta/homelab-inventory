...
describe('InventoryItemDialog switch port groups', () => {
  ...
  it('renders the constrained PC component and power equipment fields', async () => {
    ...
    expect(screen.getByRole('textbox', { name: 'Chipset' })).toBeInTheDocument()
    await user.click(screen.getByRole('tab', { name: 'CPU' }))
    expect(screen.getByRole('spinbutton', { name: 'CPU sockets' })).toBeInTheDocument()
    await user.click(screen.getByRole('tab', { name: 'Storage' }))
    expect(screen.getByRole('button', { name: 'Add storage slot group' })).toBeInTheDocument()
    await user.click(screen.getByRole('tab', { name: 'Expansion' }))
    ...
    expect(screen.getByRole('button', { name: 'Add motherboard power connector' })).toBeInTheDocument()
