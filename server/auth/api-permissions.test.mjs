...
describe('API permission classification', () => {
  it('classifies public, machine, and protected routes', () => {
    ...
    expect(classifyApiRequest('GET', '/api/projects/1/systems/server/7/attention')).toEqual({ access: 'protected', permission: 'project.view' })
    expect(classifyApiRequest('GET', '/api/projects/1/compatibility/summary')).toEqual({ access: 'protected', permission: 'audit.view' })
