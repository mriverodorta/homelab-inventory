...
const PROTECTED_ROUTES = [
  ...
  ['PUT', /^\/api\/inventory-metadata\/history\/?$/, 'inventory.edit'],
  ...
  ['GET', /^\/api\/projects\/[1-9]\d*\/compatibility\/(?:summary|findings|policy)\/?$/, 'audit.view'],
  ['PUT', /^\/api\/projects\/[1-9]\d*\/compatibility\/policy\/?$/, 'audit.manage'],
  ['PUT', /^\/api\/projects\/[1-9]\d*\/compatibility\/findings\/[1-9]\d*\/ignore\/?$/, 'audit.manage'],
  ['DELETE', /^\/api\/projects\/[1-9]\d*\/compatibility\/findings\/[1-9]\d*\/ignore\/?$/, 'audit.manage'],
