...
import { normalizeNetworkProject, recalculateNegotiatedSpeeds } from '../../db/legacy-network-normalization.ts'
...
import { assertRelationalId, isRelationalId, parseLegacyRelationalId } from '../../db/relational-ids.mjs'
import { migrateSchema9To10 } from '../../db/migrate-schema-10.mjs'
import { migrateSchema10To11 } from '../../db/migrate-schema-11.mjs'
import { migrateSchema11To12 } from '../../db/migrate-schema-12.mjs'
import { migrateSchema12To13 } from '../../db/migrate-schema-13.mjs'
import { migrateSchema13To14 } from '../../db/migrate-schema-14.mjs'
import { migrateSchema14To15 } from '../../db/migrate-schema-15.mjs'
import { migrateSchema15To16 } from '../../db/migrate-schema-16.mjs'
import { migrateSchema16To17 } from '../../db/migrate-schema-17.mjs'
import { migrateSchema17To18 } from '../../db/migrate-schema-18.mjs'
import { migrateSchema18To19 } from '../../db/migrate-schema-19.mjs'
import { migrateSchema19To20 } from '../../db/migrate-schema-20.mjs'
import { migrateSchema20To21 } from '../../db/migrate-schema-21.mjs'
import { migrateSchema21To22 } from '../../db/migrate-schema-22.mjs'
import { migrateSchema22To23 } from '../../db/migrate-schema-23.mjs'
import { migrateSchema23To24 } from '../../db/migrate-schema-24.mjs'
import { migrateSchema24To25 } from '../../db/migrate-schema-25.mjs'
import { migrateSchema25To26 } from '../../db/migrate-schema-26.mjs'
import { migrateSchema26To27 } from '../../db/migrate-schema-27.mjs'
import { migrateSchema27To28 } from '../../db/migrate-schema-28.mjs'
import { migrateSchema28To29 } from '../../db/migrate-schema-29.mjs'
import {
  applyNasPowerConfigurationChange,
  inspectNasPowerConfigurationChange,
} from '../../db/nas-power-configuration.mjs'
...
import { createNumericId, timingSafeEqualString } from '../../db/agent-auth.mjs'
import {
...
import {
  ...
  TABLE_BY_TYPE,
} from '../../db/inventory-input.mjs'
import { LEGACY_SCHEMA_VERSION } from './schema-version.mjs'

export const CURRENT_SCHEMA_VERSION = LEGACY_SCHEMA_VERSION
...
export class HomelabInventoryStore {
  ...
  async runMigrations() {
    ...
    while (currentVersion < CURRENT_SCHEMA_VERSION) {
      ...
      if (currentVersion === 22) {
        const migrated = migrateSchema22To23(this.databases.authentication.data)
        this.databases.authentication.data = migrated.authentication
        this.databases.meta.data.schemaVersion = 23
        this.databases.meta.data.lastMigration = {
          from: 22,
          to: 23,
          completedAt: new Date().toISOString(),
      ...
      if (currentVersion === 27) {
        const migrated = migrateSchema27To28(this.databases.authentication.data)
        this.databases.authentication.data = migrated.authentication
        this.databases.meta.data.schemaVersion = 28
        this.databases.meta.data.lastMigration = {
          from: 27,
          to: 28,
          completedAt: new Date().toISOString(),
  ...
  updateRegistrySettings(patch, expectedUpdatedAt) {
    ...
    return this.registryTransaction((draft) => {
      ...
      const automaticSafeUpdates = patch?.automaticSafeUpdates ?? draft.settings.automaticSafeUpdates
