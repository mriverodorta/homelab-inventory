...
const COMMON_FIELD_MAPPINGS: Readonly<Record<string, InventoryFieldMapping>> = {
  ...
  fixedComponents: { storage: 'relation', target: 'host_fixed_components' },
...
const TYPE_FIELD_MAPPINGS: Readonly<Record<InventoryType, Readonly<Record<string, InventoryFieldMapping>>>> = {
  ...
  nas: {
    ...
    'specs.formFactor': { storage: 'column', target: 'nas_systems.form_factor_text' },
    'specs.platformFamily': { storage: 'column', target: 'nas_systems.platform_family' },
    'specs.variantKey': { storage: 'column', target: 'nas_systems.variant_key' },
    'specs.hardwareRevision': { storage: 'column', target: 'nas_systems.hardware_revision' },
    'specs.boardRevision': { storage: 'column', target: 'nas_systems.board_revision' },
    'specs.releaseDate': { storage: 'column', target: 'nas_systems.release_date_text' },
    'specs.discontinued': { storage: 'column', target: 'nas_systems.discontinued' },
    'specs.widthMm': { storage: 'column', target: 'nas_systems.width_mm' },
    'specs.heightMm': { storage: 'column', target: 'nas_systems.height_mm' },
    'specs.depthMm': { storage: 'column', target: 'nas_systems.depth_mm' },
    'specs.massGrams': { storage: 'column', target: 'nas_systems.mass_grams' },
    'specs.rackUnits': { storage: 'column', target: 'nas_systems.rack_units' },
    ports: { storage: 'relation', target: 'inventory_ports' },
  },
  pcBuild: {
  ...
  network: {
    'specs.networkTechnology': { storage: 'column', target: 'network_adapters.network_technology' },
    'specs.controller': { storage: 'column', target: 'network_adapters.controller' },
    'specs.formFactor': { storage: 'column', target: 'network_adapters.form_factor' },
    'specs.maxSpeedBps': { storage: 'column', target: 'network_adapters.max_speed_bps' },
    'specs.maxPhyRateBps': { storage: 'column', target: 'network_adapters.max_phy_rate_bps' },
    'specs.spatialStreams': { storage: 'column', target: 'network_adapters.spatial_streams' },
    'specs.bluetoothVersion': { storage: 'column', target: 'network_adapters.bluetooth_version' },
    'specs.antennaTopology': { storage: 'column', target: 'network_adapters.antenna_topology' },
    'specs.hardwareRevision': { storage: 'column', target: 'network_adapters.hardware_revision' },
    'specs.discontinued': { storage: 'column', target: 'network_adapters.discontinued' },
    'specs.hostInterface': { storage: 'relation', target: 'network_adapter_host_interfaces' },
    'specs.operatingModes': { storage: 'relation', target: 'network_adapter_operating_modes' },
    'specs.wifiGenerations': { storage: 'relation', target: 'network_adapter_wifi_generations' },
    'specs.frequencyBandsGhz': { storage: 'relation', target: 'network_adapter_frequency_bands' },
    'specs.capabilities': { storage: 'relation', target: 'network_adapter_capabilities' },
    ports: { storage: 'relation', target: 'inventory_ports' },
  },
  motherboard: {
