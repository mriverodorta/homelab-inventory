...
COPY --chown=10001:10001 server/index.mjs server/agent-routes.mjs server/rate-limit.mjs server/update-checker.mjs server/update-routes.mjs server/update-scheduler.mjs ./server/
